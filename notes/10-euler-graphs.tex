...
\lemma{Nechť existuje eulerovská podmnožina hran $E'$. Potom $E'$ je je sjednocením nějakých množin \range{E_1}{E_k} $\subseteq E$ takových, že každá $E_i$ je množina hran nějaké kružnice v $G$ a všechny $E_i$ jsou navzájem disjunktní.}\label{lemma:eulerovy-mnoziny}
